...
| 2 | El usuario selecciona el tipo de tecnología usada. |
| 3 | El usuario selecciona el product owner. |
| 4 | El usuario selecciona el squad al que pertenece. |
| 5 | El usuario selecciona el nombre del responsable del documento. |
